...
class enrol_spreadsheet_external extends external_api {
    ...
    public static function enrol_users($enrolments) {
        ...
        if (empty($enrol)) {
            throw new moodle_exception('manualpluginnotinstalled', 'enrol_spreadsheet');
        }
        ...
        foreach ($params['enrolments'] as $enrolment) {
            ...
            if (!array_key_exists($enrolment['roleid'], $roles)) {
                ...
                throw new moodle_exception('wsusercannotassign', 'enrol_spreadsheet', '', $errorparams);
            }
            ...
            if (empty($instance)) {
              $errorparams = new stdClass();
              $errorparams->courseid = $enrolment['courseid'];
              throw new moodle_exception('wsnoinstance', 'enrol_spreadsheet', $errorparams);
            }
            ...
            if (!$enrol->allow_enrol($instance)) {
                ...
                $errorparams->courseid = $enrolment['courseid'];
                $errorparams->userid   = $enrolment['userid'];
                throw new moodle_exception('wscannotenrol', 'enrol_spreadsheet', '', $errorparams);
            }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.6
 * @see enrol_spreadsheet_external
 */
class moodle_enrol_spreadsheet_external extends external_api {
     ...
     * @see enrol_spreadsheet_external::enrol_users_parameters()
     */
    public static function manual_enrol_users_parameters() {
        return enrol_spreadsheet_external::enrol_users_parameters();
    }
     ...
     * @since Moodle 2.0
     * @deprecated Moodle 2.2 MDL-29106 - Please do not call this function any more.
     * @see enrol_spreadsheet_external::enrol_users()
     */
    public static function manual_enrol_users($enrolments) {
        return enrol_spreadsheet_external::enrol_users($enrolments);
    }
     ...
     * @since Moodle 2.0
     * @deprecated Moodle 2.2 MDL-29106 - Please do not call this function any more.
     * @see enrol_spreadsheet_external::enrol_users_returns()
     */
    public static function manual_enrol_users_returns() {
        return enrol_spreadsheet_external::enrol_users_returns();
    }
